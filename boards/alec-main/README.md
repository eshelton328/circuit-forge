...
- [Schematic PDF](review/schematic.pdf) and [native schematic](alec-main.kicad_sch)
- [Native PCB](alec-main.kicad_pcb), [top view](review/pcb-top.png), [back view](review/pcb-bottom.png), [BOM](review/bom.csv)
...
- [Integrated v4.2 enclosure](../../enclosures/alec/pcb-revision/README.md)
