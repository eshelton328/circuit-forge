...
Do not advertise weeks of continuous LD2410C presence sensing on three AA cells. If long life and all-day detection are both mandatory, revisit the sensor choice or power source before a production revision. S1 keeps the requested LD2410C.
...
No application firmware has been implemented or bench-tested in S1. These are the implementation and test requirements for the next firmware pass.
