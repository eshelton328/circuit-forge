...
def check(path=D/'review/netlist.xml'):
 ...
 same('Fuse receives raw battery input','J1.1','F1.1')
 same('Fused battery feeds switch common pin2','F1.2','SW1.2')
 apart('Fuse cannot be bypassed','F1.1','F1.2')
 same('Hard switch output feeds reverse-protection FET drain','SW1.1','Q1.3')
