...
`alec-cube-v4.blend` is the original accepted v4 packaging scene, before the 1.3-inch display update. It is retained as an immutable comparison input, with its SHA-256 recorded in `../source-manifest.json`.
