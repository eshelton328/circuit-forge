...
bpy.ops.wm.open_mainfile(filepath=str(R/'alec-cube-v4-1.blend'))
...
result=dict(tested_blend_sha256=hashlib.sha256((R/'alec-cube-v4-1.blend').read_bytes()).hexdigest(),status='NOMINAL_GEOMETRY_CHECKS_PASS' if not failures else 'GEOMETRY_FAILURES',physical_qualification_performed=False,manufacturing_release=False,
...
def snapshot():
 ...
 return out
updated=snapshot()
bpy.ops.wm.open_mainfile(filepath=str(R/'reference/alec-cube-v4.blend'))
