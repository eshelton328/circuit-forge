...
save('alec-cube-v4-1.blend',frontcam);do_render('exterior-front-right.png',frontcam);do_render('exterior-rear-left.png',rearcam)
...
save('alec-cube-v4-1-internals.blend',cutcam);do_render('internals.png',cutcam)
...
save('alec-cube-v4-1-acoustic-cutaway.blend',sectioncam);do_render('acoustic-cutaway.png',sectioncam)
visible(guides,True);save('alec-cube-v4-1-clearances.blend',sectioncam);do_render('clearances.png',sectioncam);visible(guides,False)
...
save('alec-cube-v4-1-service.blend',bottomcam);do_render('bottom-service.png',bottomcam)
