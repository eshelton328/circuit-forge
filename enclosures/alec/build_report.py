...
if hashlib.sha256((R/'alec-cube-v4-1.blend').read_bytes()).hexdigest()!=v['tested_blend_sha256']:
...
The tested artifact is the saved `alec-cube-v4-1.blend`, reopened independently by `verify_assembly.py` under Blender 5.2.1 LTS. The native main PCB was not changed; SHA-256: `{p['pcb_sha256']}`. This is the v4.1 EastRising 1.3-inch display update to the preserved v4 enclosure. There is no new PCB-layout simulation or SPICE result in this revision.
...
t(60,65,'ALEC / V4.1',34,bold=True);t(60,103,'Direct radiator • Protected setup panel • 105 mm body • All dimensions in mm',20)
...
(R/'index.html').write_text('''<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>ALEC v4.1</title><style>body{margin:0;background:#eef1ef;color:#263a3e;font:17px/1.5 system-ui}main{max-width:1180px;margin:auto;padding:32px}h1{font-size:40px;margin-bottom:8px}nav{display:flex;flex-wrap:wrap;gap:18px;margin:24px 0}a{color:#146d70}.notice{background:#ffedcf;padding:18px;border-radius:8px}.grid{display:grid;grid-template-columns:1fr 1fr;gap:22px}figure{margin:0;background:white;border-radius:12px;overflow:hidden}img{display:block;width:100%}figcaption{padding:14px}figure:last-child{grid-column:1/-1}@media(max-width:700px){.grid{grid-template-columns:1fr}h1{font-size:30px}}</style><main><h1>ALEC / v4.1</h1><p>105 mm body · Direct front speaker · Four perforated walls · Protected bottom setup</p><p class="notice">{CHECK_COUNT} nominal geometry checks passed. Physical acoustic, battery, thermal and radio tests are pending. Amber parts and new PCB interfaces remain provisional.</p><nav><a href="alec-cube-v4-1.blend">Assembled Blender</a><a href="alec-cube-v4-1-acoustic-cutaway.blend">Acoustic cutaway</a><a href="alec-cube-v4-1-service.blend">Bottom service</a><a href="DISPLAY-UPDATE.md">Display update</a><a href="DESIGN-REVIEW.md">Design review</a><a href="TEST-REPORT.md">Test report</a><a href="PCB-INTERFACE.md">PCB revision brief</a></nav><div class="grid">'''+body+'</div></main></html>')
...
manifest['files']['reference/alec-cube-v4.blend']=hashlib.sha256((R/'reference/alec-cube-v4.blend').read_bytes()).hexdigest()
