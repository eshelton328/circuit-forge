# Bedroom alarm — v4.1 design review
...
Open [the gallery](index.html), [assembled Blender model](bedroom-cube-v4-1.blend), [acoustic cutaway](bedroom-cube-v4-1-acoustic-cutaway.blend), [bottom service model](bedroom-cube-v4-1-service.blend), or [dimensioned drawing](dimensioned-layout.svg). See the [test report](TEST-REPORT.md) for what was actually checked.
