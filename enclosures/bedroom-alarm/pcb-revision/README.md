# Bedroom alarm v4.2 — integrated PCB prototype
...
- [Complete Blender assembly](bedroom-cube-v4-2.blend)
- [Internal inspection view](bedroom-cube-v4-2-internals.blend)
- [Protected bottom service view](bedroom-cube-v4-2-service.blend)
- [Test report](TEST-REPORT.md), [geometry results](verification.json), [source hashes](assembly-sources.json)
- [Main PCB](../../../boards/bedroom-alarm-main/README.md), [bottom controls](../../../boards/bedroom-alarm-controls/README.md), [front controls](../../../boards/bedroom-alarm-front/README.md)
