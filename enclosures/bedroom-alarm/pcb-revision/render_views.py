...
bpy.ops.wm.open_mainfile(filepath=str(R/'bedroom-cube-v4-2.blend'));s=bpy.context.scene
...
bpy.ops.wm.save_as_mainfile(filepath=str(R/'bedroom-cube-v4-2-internals.blend'))
bpy.ops.wm.open_mainfile(filepath=str(R/'bedroom-cube-v4-2.blend'));s=bpy.context.scene
...
bpy.ops.wm.save_as_mainfile(filepath=str(R/'bedroom-cube-v4-2-service.blend'))
