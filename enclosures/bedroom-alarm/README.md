...
| Deliverable | Purpose |
|---|---|
| [Assembled Blender model](bedroom-cube-v4-1.blend) | Full editable assembly, including the actual imported PCB and holder meshes |
| [Bottom service model](bedroom-cube-v4-1-service.blend) | Bottom cover removed; larger display and hidden settings controls |
| [Internal assembly](bedroom-cube-v4-1-internals.blend) | Outer walls hidden; speaker pod remains closed |
| [Acoustic cutaway](bedroom-cube-v4-1-acoustic-cutaway.blend) | One pod wall and roof hidden for inspection |
| [Clearance view](bedroom-cube-v4-1-clearances.blend) | RF, motion and provisional component envelopes |
