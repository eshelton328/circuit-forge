...
The tested artifact is the saved `bedroom-cube-v4-1.blend`, reopened independently by `verify_assembly.py` under Blender 5.2.1 LTS. The native main PCB was not changed; SHA-256: `0e17f9ad0cf0508d8a53ed51c0b1e6af4423311598bbb03fe811c556e8b1e7d8`. This is the v4.1 EastRising 1.3-inch display update to the preserved v4 enclosure. There is no new PCB-layout simulation or SPICE result in this revision.
