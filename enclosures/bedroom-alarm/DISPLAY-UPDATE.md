...
Open [the bottom service view](bottom-service.png), [assembled model](bedroom-cube-v4-1.blend), [service model](bedroom-cube-v4-1-service.blend), [gallery](index.html), or [test report](TEST-REPORT.md). The original accepted v4 scene is preserved in [reference/](reference/README.md). This complete v4.1 deliverable is tracked under `enclosures/bedroom-alarm/`.
